...
//	static bool isMan = true;			
//
//	//人物移动方向上的下一个单元格nextCell
//	Cell *nextCell = m_cells[cell->getRow() - 1 + x][cell->getCol() - 1 + y];	
...
//	case BLANK:
//	case DESTINATION:
//		nextCell->setType(static_cast<CellType>(type + cell->getType()));
//		if (isMan){
//			cell->setType(static_cast<CellType>(cell->getType() - MAN));
//			cell = nextCell;
//		}
